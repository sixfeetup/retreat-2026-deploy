...
Add your cluster to ArgoCD. This will also output the `CLUSTER_IP` you will use in the application.
    ...
    $ argocd cluster add retreat_2026_deploy-environment
...
If you are working in the SFU environment move your application and repocreds manifest to `sixfeetup/controlplane.git/argocd/applications/retreat_2026_deploy/`

Apply the manifests

    $ kubectl apply -f argocd/applications/retreat_2026_deploy
