module "cluster" {
  source                 = "../modules/base"
  environment            = "staging"
  cluster_name           = "retreat-2026-deploy-staging"
  domain_name            = "staging.retreat2026.scaf.sixfeetup.com"
  api_domain_name        = "api.staging.retreat2026.scaf.sixfeetup.com"
  cluster_domain_name    = "k8s.staging.retreat2026.scaf.sixfeetup.com"
  argocd_domain_name     = "argocd.staging.retreat2026.scaf.sixfeetup.com"
  prometheus_domain_name = "prometheus.staging.retreat2026.scaf.sixfeetup.com"
