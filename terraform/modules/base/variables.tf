...
variable "cluster_name" {
  ...
  type        = string
  default     = "retreat-2026-deploy-sandbox"
}

variable "domain_name" {
  type    = string
  default = "retreat2026.scaf.sixfeetup.com"
}

variable "api_domain_name" {
  type    = string
  default = "api.retreat2026.scaf.sixfeetup.com"
}

variable "cluster_domain_name" {
  type    = string
  default = "k8s.retreat2026.scaf.sixfeetup.com"
}


variable "argocd_domain_name" {
  type    = string
  default = "argocd.retreat2026.scaf.sixfeetup.com"
}


variable "prometheus_domain_name" {
  type    = string
  default = "prometheus.retreat2026.scaf.sixfeetup.com"
}
...
variable "repo_url" {
  type    = string
  default = "git@github.com:sixfeetup/retreat-2026-deploy.git"
}
...
variable "backend_ecr_repo" {
  ...
  type        = string
  default     = "retreat-2026-deploy-sandbox-backend"
}
