...
1. Get the repository
       ...
       $ git clone git@github.com:sixfeetup/retreat-2026-deploy.git
       $ cd retreat_2026_deploy
...
## Run the kubernetes cluster and the retreat_2026_deploy app to develop the code
...
To remove the cluster entirely:
       ...
       $ kind delete cluster --name retreat_2026_deploy
