...
2. Choose Django
3. Name the Project with client-backend naming convention (ex. retreat-2026-deploy-backend)
...
7. Choose Next.js
8. Name the Project with client-frontend naming convention (ex. retreat-2026-deploy-frontend)
