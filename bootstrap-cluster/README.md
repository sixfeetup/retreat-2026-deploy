...
2. Review the `.env` file for the given environment:
   ...
   ```shell
   CONTROL_PLANE_ENDPOINT: "https://k8s.sandbox.retreat2026.scaf.sixfeetup.com:6443"
...
4. Test kubectl access:
   ...
   ```shell
   $ kubectl cluster-info
   Kubernetes control plane is running at https://k8s.sandbox.retreat2026.scaf.sixfeetup.com:6443
   CoreDNS is running at https://k8s.sandbox.retreat2026.scaf.sixfeetup.com:6443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
